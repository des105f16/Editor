    ...
    public class Lexer : SablePP.Tools.Lexing.Lexer
    {
        ...
        protected override SablePP.Tools.Nodes.Token getToken(int tokenIndex, string text, int line, int position)
        {
            switch (tokenIndex)
            {
                ...
                case 47: return new TLPar(text, line, position);
                case 48: return new TRPar(text, line, position);
                case 49: return new TLSqu(text, line, position);
                case 50: return new TRSqu(text, line, position);
                case 51: return new TLCur(text, line, position);
                case 52: return new TRCur(text, line, position);
                case 53: return new TJoin(text, line, position);
                case 54: return new TComment(text, line, position);
                case 55: return new TWhitespace(text, line, position);
                default:
        ...
        private static int[][] acceptTable = {
            new int[] {
                -1, 55, 55, 55, 55, 37, 18, 0, 36, -1, 16, 47, 48, 34, 32, 41,
                33, 40, 35, 4, 42, 43, 28, 29, 28, -1, 19, 19, 49, 50, 31, 30,
                19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 51, -1, 52, 53, 18, 17,
                18, 0, 38, 16, 15, 16, -1, 26, -1, 54, 27, -1, 28, 22, 28, 28,
                -1, 21, 19, 19, 19, 19, 19, 19, 19, 19, 9, 19, 19, 19, 19, 19,
                19, 19, 44, 23, 39, 18, 17, 18, 16, 15, 16, 20, -1, -1, 54, 24,
                25, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 21, -1, 54, 14,
                19, 10, 19, 19, 19, 19, 12, 3, 19, 19, -1, -1, 19, 3, 19, 19,
                19, 19, 8, 13, 19, 11, 7, 19, 19, 6, 19, 5,
            },
            new int[] {
                -1, 55, 55, 55, 55, 37, 18, 0, 36, -1, 16, 47, 48, 34, 32, 41,
                33, 40, 35, 4, 42, 43, 28, 29, 28, -1, 45, 19, 19, 49, 50, 31,
                30, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 51, -1, 52, 53, 18,
                17, 18, 0, 38, 16, 15, 16, -1, 26, -1, 54, 27, -1, 28, 22, 28,
                28, -1, 21, 19, 19, 19, 19, 19, 19, 19, 19, 9, 19, 19, 19, 19,
                19, 19, 19, 23, 39, 46, 18, 17, 18, 16, 15, 16, 20, -1, -1, 54,
                24, 25, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 21, -1, 54,
            ...
            new int[] {
                -1, 55, 55, 55, 55, 37, 18, 0, 36, -1, 16, 47, 48, 34, 32, 41,
                33, 40, 35, 4, 42, 43, 28, 29, 28, -1, 19, 19, 49, 50, 31, 30,
                19, 19, 2, 19, 19, 2, 19, 2, 19, 19, 2, 19, 19, 51, -1, 52,
                53, 18, 17, 18, 0, 38, 16, 15, 16, -1, 26, -1, 54, -1, 27, -1,
                28, 22, 28, 28, -1, 21, 19, 19, 19, 19, 19, 19, 19, 19, 9, 2,
                19, 19, 19, 19, 19, 19, 19, 23, 39, 46, 18, 17, 18, 16, 15, 16,
                20, -1, -1, 54, 1, 24, 25, 19, 19, 19, 19, 19, 19, 19, 19, 19,
                19, 19, 21, -1, 54, 14, 19, 10, 19, 19, 19, 19, 12, 3, 19, 19,
