...
namespace DLM.Wpf
{
    public class InferenceStepErrorView
    {
        private ConstraintResolver<NodeConstraint>.Step step;

        public InferenceStepErrorView(ConstraintResolver<NodeConstraint>.Step step)
        {
            this.step = step;
        }
        ...
        public Label MeetWithNoVars => step.Right.NoVariables;
